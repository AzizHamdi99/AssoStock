...
const Page = () => {
    ...
    return (
        <div className="overflow-x-scroll p-6">
            ...
            {/* Table Header */}
            <div className="grid grid-cols-[0.5fr_0.5fr_1fr_1fr_0.5fr_0.5fr_1fr_1fr] font-bold bg-[#f7e8cf] text-[#5c381b] py-3 px-4 rounded-t-lg">
                <p>#</p>
                <p>Image</p>
                <p>Name</p>
                <p>Description</p>
            ...
            {products?.map((product, index) => {
                ...
                return (
                    <div
                        key={product._id}
                        className="grid grid-cols-[40px_80px_1fr_2fr_80px_80px_1fr_150px] items-center border-b border-[#f3d3bc] px-4 py-3 text-sm text-[#4b392e]"
                    >
                        <p>{index + 1}</p>
