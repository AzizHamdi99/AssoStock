...
const Page = () => {
    ...
    return (
        <div className="overflow-x-scroll xl:overflow-x-hidden xl:mx-32 my-10 ">
            ...
            {/* Table Header */}
            <div className="grid grid-cols-[0.5fr_0.5fr_1fr_1fr_0.5fr_0.5fr_1fr_1fr] font-bold  text-[#a3886d] my-4">
                <p>#</p>
                <p>Image</p>
                <p>Name</p>
                <p>Description</p>
            ...
            {products?.map((product, index) => {
                ...
                return (
                    <div
                        key={product._id}
                        className="grid grid-cols-[0.5fr_0.5fr_1fr_1fr_0.5fr_0.5fr_1fr_1fr] items-center border-b border-[#f3d3bc] py-3 text-sm text-[#a5886a] font-medium"
                    >
                        <p>{index + 1}</p>
                        ...
                        <div className="flex items-center gap-2">
                            <button className="bg-[#fc9c9e] hover:bg-[#f66f75] text-white px-2 py-1 rounded text-xs flex items-center gap-1">
