...
const Page = () => {
    ...
    return (
        <div className="overflow-x-scroll xl:overflow-x-hidden xl:mx-32 my-10 ">
            ...
            {/* Table Header */}
            <div className="grid grid-cols-[0.5fr_0.5fr_1fr_1fr_0.5fr_0.5fr_1fr_1fr] font-bold  text-[#5c381b] m-y-4">
                <p>#</p>
                <p>Image</p>
                <p>Name</p>
                <p>Description</p>
            ...
            {products?.map((product, index) => {
                ...
                return (
                    <div
                        key={product._id}
                        className="grid grid-cols-[0.5fr_0.5fr_1fr_1fr_0.5fr_0.5fr_1fr_1fr] items-center border-b border-[#f3d3bc] py-3 text-sm text-[#4b392e]"
                    >
                        <p>{index + 1}</p>
