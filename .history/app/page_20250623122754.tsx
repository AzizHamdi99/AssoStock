        ...
        <div className="md:w-1/3">
          <div className="border-2 border-[#e2d9be] p-4 py-6 rounded-xl flex flex-col shadow-sm  gap-5">
            ...
            <div className="flex gap-4 items-center">
              ...
              <p className="text-[#815232] font-bold"> Out of stock <span className="ml-4 px-3 py-0.5 rounded-sm bg-[#f1dbc2] text-[#cd3700]">{products?.filter((p) => p?.quantity === 0).length} </span></p>
            </div>
