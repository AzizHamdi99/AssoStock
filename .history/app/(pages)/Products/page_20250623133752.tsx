        ...
        <div className="p-4 lg:p-6 xl:mx-32 my-4 lg:my-10">
            ...
            <div className="hidden lg:block">
                <div className="bg-white rounded-xl shadow-sm border border-[#f3d3bc] overflow-hidden">
                    {/* Table Header */}
                    <div className="grid grid-cols-[0.3fr_0.4fr_1.2fr_1.5fr_0.6fr_0.6fr_1fr_0.8fr] bg-gradient-to-r from-[#f8f4f0] gap-1 to-[#f3e6d4] px-6 py-4 font-semibold text-[#5c381b] text-sm border-b border-[#f3d3bc]">
                        <span>#</span>
                        <span>Image</span>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-2">
                                        <Link href={`/updateProduct/${product._id}`} className="bg-[#fc9c9e] hover:bg-[#f66f75] text-white px-3 py-1.5 rounded-lg text-xs font-medium flex items-center gap-1.5 transition-colors duration-200">
                                            <Pencil size={12} /> Edit
                                        </Link>
                        ...
                        >
                                ...
                                <div className="relative">
                                    ...
                                    {activeDropdown === product._id && (
                                        <div className="absolute right-0 top-full mt-1 bg-white border border-[#f3d3bc] rounded-lg shadow-lg z-10 min-w-[140px]">
                                            <Link href={`/updateProduct/${product._id}`} className="w-full px-3 py-2 text-left hover:bg-[#f8f4f0] flex items-center gap-2 text-sm text-[#5c381b]">
                                                <Pencil size={14} /> Edit
                                            </Link>
                                            <button className="w-full px-3 py-2 text-left hover:bg-red-50 flex items-center gap-2 text-sm text-red-600" onClick={() => handleDeleteProduct(product._id)}>
                            ...
                            <div className="p-4">
                                ...
                                <div className="flex items-center justify-between pt-3 border-t border-[#f3d3bc]">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <Link href={`/updateProduct/${product._id}`} className="bg-[#fc9c9e] hover:bg-[#f66f75] text-white px-3 py-2 rounded-lg text-xs font-medium flex items-center gap-1.5 transition-colors duration-200">
                                            <Pencil size={12} /> Edit
                                        </Link>
                                        <button className="bg-[#f3e6d4] hover:bg-[#f1d0b5] text-[#802d32] p-2 rounded-lg transition-colors duration-200" onClick={() => handleDeleteProduct(product._id)}>
                                            <Trash2 size={14} />
                                        </button>
                                    </div>
                                </div>
