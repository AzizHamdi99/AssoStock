...
const page = () => {
    ...
    return (
        <div className='mx-4 md:mx-10 xl:mx-32 my-10 flex flex-col gap-4 md:flex-row'>
            ...
            <div className='md:w-2/3 flex flex-col gap-5 border-2 border-[#dad0b5] rounded-xl p-5'>
                <h2 className="text-xl font-bold text-[#794d2a]">Donation Cart</h2>
                {cart.length === 0 ? (
                    <div className='flex items-center justify-center flex-col'>
                        <HandHeart size={100} className='text-[#f7999b]' />
                        <p className="text-[#794d2a] text-[16px]">No products added yet.</p>
                    </div>
                ) : (
                    <table className="w-full text-left border-separate border-spacing-y-2">
                        ...
                        <tbody>
                            {cart.map((item, i) => {
                                ...
                                return (
                                    <tr key={i} className="bg-[#f5ead7] rounded-xl">
                                        <td>
                ...
                {cart.length > 0 && (
                    <Button className="bg-[#f5857f] hover:bg-[#e56d6d] text-white w-fit mt-4">
                        Confirm Donation
                    </Button>
                )}
            </div>
