      ...
      <div className=" mx-4 flex flex-col gap-5 md:flex-row md:mx-10 lg:mx-32 my-10">
        ...
        <div className="md:w-1/3 flex flex-col gap-4">
          ...
          <div className="border-2 border-[#e2d9be] p-4 py-6 rounded-xl flex flex-col shadow-sm  gap-5">
            ...
            <div className="grid grid-cols-[0.5fr_1fr_1.5fr_1fr] items-center gap-1 border-b-2 border-[#ecd7cf] py-2 text-[#af8f6e] font-semibold">
              <p>.</p>
              <p>Image</p>
              <p>Name</p>
              <p>Quantity</p>
            ...
            {products?.filter((p) => p?.quantity === 0).slice(0, 5)?.map((prod, i) => {
              return (
                <div className="grid grid-cols-[0.5fr_1fr_1.5fr_1fr] items-center gap-1 border-b-2 border-[#ecd7cf] py-2">
