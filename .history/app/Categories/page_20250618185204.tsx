                        ...
                        <div className='flex items-center gap-3'>
                            <Dialog>
                                ...
                                <DialogContent className="sm:max-w-[425px] bg-[#ece3ca] text-[#7c5b3b]">
                                    ...
                                    <div className="grid gap-4">
                                        <Input placeholder='Title' value={ } onChange={e => setEditName(e.target.value)} />
                                        <Input placeholder='Description' value={cat.description} onChange={e => setEditDescription(e.target.value)} />
                                    </div>
                                    <DialogFooter>
                                        <DialogClose asChild>
                                            <Button variant="outline" className='cursor-pointer'>Cancel</Button>
