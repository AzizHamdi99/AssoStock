        ...
        <div className="md:w-1/3">
          <div className="border-2 border-[#e2d9be] p-4 py-6 rounded-xl flex flex-col shadow-sm  gap-5">
            ...
            <div className="flex gap-4 items-center">
              ...
              <p className="text-[#815232] font-bold">Normal stock <span className="ml-4 px-3 py-0.5 rounded-sm bg-[#dbdac6] text-[#02bf67]"> {products?.filter((p) => p?.quantity > 2).length} </span></p>
            </div>
            <div className="flex gap-4 items-center">
