...
const NavItems = () => (
    <>
        ...
        <NavLink icon={PackagePlus} label="New Product" link={"/"} />
        <NavLink icon={ListTree} label="Categories" link={"/"} />
        <NavLink icon={HandCoins} label="Sell" link={"/"} />
        <NavLink icon={Receipt} label="Transactions" link={"/"} />
        <NavLink icon={Warehouse} label="Refill Stock" link={"/"} />
    </>
)
