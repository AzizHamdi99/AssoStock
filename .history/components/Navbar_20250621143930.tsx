        ...
        <nav className="border-b-[1px] border-[#cec19d] text-[#7c5b3b]">
            <div className="flex items-center justify-between px-6 py-4 xl:px-32">
                ...
                <div className="hidden xl:flex items-center gap-3">
                    <NavItems pathName={pathName} products={products} categories={categories} />
                </div>
...
const NavItems = ({ pathName, products, categories }: { pathName: string, products: any, categories: any }) => (
    <>
        ...
        <Dialog>
            ...
            <DialogContent className="sm:max-w-md bg-[#ece3ca]">
                <DialogHeader>
                    <DialogTitle className='text-[#794422] font-semibold'>Stock Management</DialogTitle>
                    <DialogDescription>
